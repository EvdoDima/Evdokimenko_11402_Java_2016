...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <#--<li class="active"><a href="/index"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg> Dashboard</a></li>-->
        <li<#if menuitem.name?matches(currpage,"i")> class="active"</#if>>
            <a href="/${menuitem.name}">${menuitem.icon} ${menuitem.name?capitalize}</a></li>
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">${currpage?capitalize}</h1>
        </div>
    </div><!--/.row-->
